...
$$g_2 = \begin{cases}
	...
	0,\text{ else}
\end{cases}$$
%$g_1, g_2$ are two functions that can be optimized computationally to design instruments that best match a given target range like \targetrange or another preferred range. 
