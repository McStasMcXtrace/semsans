...
The goal was to explore possibilities for an instrument for the target range $10 \unit{\nano\meter}$ to $5 \unit{\micro\meter}$ and the lower $\delta$ values of $10 - 100 \unit{\nano\meter}$ proved to be an inherent challenge to cold neutron instruments, especially those at $\lambda_0 = 8$Å. 
