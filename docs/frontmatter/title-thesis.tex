...
\begin{tabular}{p{15mm}p{10cm}}
    Cover: & A raytraced 3D plot of detector intensities for a dilute solution of solid spheres with $R = 300 \unit{\nano\meter}$. The source is monochromatic and $\lambda$ varies from $2$~Å to $12$~Å.\\
